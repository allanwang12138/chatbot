...
_BEGINNER_DETAILED = """You are a patient and friendly tutor helping someone completely new to {textbook}.
Based only on the context below, explain clearly in ≤20 sentences, no jargon.
Context:
{context}
Question:
{question}
...
_BEGINNER_CONCISE = """You are helping a beginner understand {textbook}. Answer in ≤4 simple sentences.
Context:
{context}
Question:
{question}
...
_INTERMEDIATE_CONCISE = """You are a tutor for {textbook}. Provide a concise answer in ≤4 sentences.
Context:
{context}
Question:
{question}
...
_ADVANCED_CONCISE = """You're replying to an advanced student in {textbook}. Answer in ≤4 sentences.
Context:
{context}
Question:
{question}
